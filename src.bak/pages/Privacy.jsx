        ...
        <div className="prose prose-sm max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              ...
              You can do this by contacting us through our Contact page or by accessing your account settings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              ...
              <a href="/contact" className="text-orange-primary hover:underline"> Contact page</a>.
            </p>
          </section>
        </div>
      </div>
