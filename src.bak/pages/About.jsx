...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="bg-gradient-to-br from-orange-primary to-orange-dark text-white py-20 md:py-24 px-4 md:px-6 lg:px-10 text-center">
      ...
      {/* Team */}
      <section className="py-16 md:py-20 px-4 md:px-6 lg:px-10 bg-orange-light">
        <div className="max-w-6xl mx-auto">
